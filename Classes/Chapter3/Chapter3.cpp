...
bool Chapter3::init()
{
	...
	menuItem1->setCallback([&](cocos2d::Ref *sender) {
		...
		auto newSprite = Sprite::create("chapter3/Blue_Front1.png");
	...
	menuItem2->setCallback([&](cocos2d::Ref *sender) {
		auto dirs = Director::getInstance()->getRunningScene();
		auto newSprite = Sprite::create("chapter3/Blue_Front1.png", Rect(0, 0, 50, 50));
	...
	menuItem3->setCallback([&](cocos2d::Ref *sender) {
		...
		spritecache->addSpriteFramesWithFile("chapter3/sprites.plist");
	...
	menuItem4->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem5->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem5->setCallback([&](cocos2d::Ref *sender) {
		...
		auto point00 = Sprite::create("chapter3/dot.png");
		point00->setName("point00");
		point00->setPosition(newSprite->getPosition());
		dirs->addChild(point00, 2);

		auto newSpriteScaleXY = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointXY = Sprite::create("chapter3/dot.png");
		pointXY->setName("pointXY");
		pointXY->setPosition(newSpriteScaleXY->getPosition());
		dirs->addChild(pointXY, 2);

		auto newSpriteScaleX = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointX = Sprite::create("chapter3/dot.png");
		pointX->setName("pointX");
		pointX->setPosition(newSpriteScaleX->getPosition());
		dirs->addChild(pointX, 2);

		auto newSpriteScaleY = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointY = Sprite::create("chapter3/dot.png");
	...
	menuItem6->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem6->setCallback([&](cocos2d::Ref *sender) {
		...
		auto newSprite00 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto newSprite01 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto point01 = Sprite::create("chapter3/dot.png");
		point01->setName("point01");
		point01->setPosition(newSprite01->getPosition());
		dirs->addChild(point01, 2);

		auto newSprite10 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto point10 = Sprite::create("chapter3/dot.png");
		point10->setName("point10");
		point10->setPosition(newSprite10->getPosition());
		dirs->addChild(point10, 2);

		auto newSprite11 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto point11 = Sprite::create("chapter3/dot.png");
		point11->setName("point11");
		point11->setPosition(newSprite11->getPosition());
		dirs->addChild(point11, 2);

		auto newSprite22 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto point22 = Sprite::create("chapter3/dot.png");
	...
	menuItem7->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem7->setCallback([&](cocos2d::Ref *sender) {
		...
		auto pointN = Sprite::create("chapter3/dot.png");
		pointN->setName("pointN");
		pointN->setPosition(newSprite->getPosition());
		dirs->addChild(pointN, 2);

		auto newSpriteSkewX = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto newSpriteSkewY = Sprite::create("chapter3/Blue_Front1.png");
	...
	menuItem8->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem8->setCallback([&](cocos2d::Ref *sender) {
		...
		auto newSpriteRotateP20 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointP20 = Sprite::create("chapter3/dot.png");
		pointP20->setName("pointP20");
		pointP20->setPosition(newSpriteRotateP20->getPosition());
		dirs->addChild(pointP20, 2);

		auto newSpriteRotateN20 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointN20 = Sprite::create("chapter3/dot.png");
		pointN20->setName("pointN20");
		pointN20->setPosition(newSpriteRotateN20->getPosition());
		dirs->addChild(pointN20, 2);

		auto newSpriteRotateP60 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointP60 = Sprite::create("chapter3/dot.png");
		pointP60->setName("pointP60");
		pointP60->setPosition(newSpriteRotateP60->getPosition());
		dirs->addChild(pointP60, 2);

		auto newSpriteRotateN60 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto pointN60 = Sprite::create("chapter3/dot.png");
	...
	menuItem9->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem9->setCallback([&](cocos2d::Ref *sender) {
		...
		auto newSprite2 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto newSprite3 = Sprite::create("chapter3/Blue_Front1.png");
		...
		auto newSprite4 = Sprite::create("chapter3/Blue_Front1.png");
	...
	menuItem10->setFontNameObj("fonts/Marker Felt.ttf");
...
void Chapter3::menuExitCallback(Ref* pSender)
{
