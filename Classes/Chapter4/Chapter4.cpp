...
bool Chapter4::init()
{
	...
	menuItem2->setCallback([&](Ref *sender) {
		...
		auto newSprite3 = Sprite::create("chapter4/Blue_Front1.png");
	...
	menuItem11->setFontNameObj("fonts/Marker Felt.ttf");
	...
	menuItem11->setCallback([&](Ref *sender) {
		...
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Front1.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Front2.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Front3.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Left1.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Left2.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Left3.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Back1.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Back2.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Back3.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Right1.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Right2.png", Rect(0, 0, 65, 81)));
		animFrames.pushBack(SpriteFrame::create("chapter4/Blue_Right3.png", Rect(0, 0, 65, 81)));
	...
	menuItem4->setCallback([&](Ref *sender) {
		...
		auto point2 = Sprite::create("chapter4/dot.png");
		...
		auto point3 = Sprite::create("chapter4/dot.png");
	...
	menuItem7->setCallback([&](Ref *sender) {
		...
		//        auto newSprite3 = Sprite::create("chapter4/White_Front1.png");
...
void Chapter4::menuExitCallback(Ref* pSender)
{
