...
bool PhysicsDemoCorrelationToSprite::init()
{
    if (PhysicsDemo::init()) {
        ...
        //create a sprite
        auto sprite = Sprite::create("chapter12/whiteSprite.png");
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            sprite = Sprite::create("chapter12/blueSprite.png");
...
bool PhysicsDemo::init()
{
    if (Layer::init())
    {
        ...
        //create menu
        auto backItem = MenuItemImage::create("chapter12/leftNormal.png", "chapter12/leftSelected.png", CC_CALLBACK_1(PhysicsDemo::backCallback, this) );
        auto restartItem = MenuItemImage::create("chapter12/restartNormal.png", "chapter12/restartSelected.png", CC_CALLBACK_1(PhysicsDemo::restartCallback, this) );
        auto nextItem = MenuItemImage::create("chapter12/rightNormal.png", "chapter12/rightSelected.png", CC_CALLBACK_1(PhysicsDemo::nextCallback, this) );
...
{
    static std::string sprites[] = {"chapter12/blueSprite.png","chapter12/whiteSprite.png","chapter12/LightBlueSprite.png"};
