...
void Chapter5::initialize()
{
    ...
    auto thisSceneLabel = Label::createWithTTF("This Is A Scene", "fonts/Marker Felt.ttf", 32);
...
Scene* Chapter5::createScene2()
{
    ...
    auto thisSceneLabel = Label::createWithTTF("This Is A New Scene", "fonts/Marker Felt.ttf", 32);
    thisSceneLabel->setPosition(Vec2(visibleSize.width/2, visibleSize.height/2));
...
Scene* Chapter5::createScene3()
{
    ...
    auto thisSceneLabel = Label::createWithTTF("This Scene used a Transition!", "fonts/Marker Felt.ttf", 32);
    thisSceneLabel->setPosition(Vec2(visibleSize.width/2, visibleSize.height/2));
...
Scene* Chapter5::createScene4()
{
    ...
    auto thisSceneLabel = Label::createWithTTF("This Scene used a Flip!", "fonts/Marker Felt.ttf", 32);
    thisSceneLabel->setPosition(Vec2(visibleSize.width/2, visibleSize.height/2));
